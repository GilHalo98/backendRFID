...
function cargaEstaticaControladores() {
    ...
    const consultaRol = require('./consultar.js');
    const eliminarRol = require('./eliminar.js');
    const modificarRol = require('./modificar.js');
    const registrarRol = require('./registrar.js');
