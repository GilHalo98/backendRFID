...
exports.consultaReporteChequeo = async(request, respuesta) => {
    // GET Request.
    ...
    try {
        ...
        const totalRegistros = await ReportesChequeos.count({
            where: datos,
        });
...
exports.modificarReporteChequeo = async(request, respuesta) => {
    // PUT Request.
    const cabecera = request.headers;
    const cuerpo = request.body;
    const parametros = request.params;
    ...
    try {
        ...
        const registro = await ReportesChequeos.findByPk(id);
...
exports.eliminarReporteChequeo = async(request, respuesta) => {
    // DELETE Request.
    const cabecera = request.headers;
    const cuerpo = request.body;
    const parametros = request.params;
