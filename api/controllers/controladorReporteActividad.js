...
exports.consultaReporteActividad = async(request, respuesta) => {
    // GET Request.
...
exports.registrarReporteActividad = async(request, respuesta) => {
    // POST Request.
    const cabecera = request.headers;
    const cuerpo = request.body;
    const parametros = request.params;
    ...
    try {
        ...
        await ReportesActividades.create(nuevoRegistro);
...
exports.modificarReporteActividad = async(request, respuesta) => {
    // PUT Request.
    const cabecera = request.headers;
    const cuerpo = request.body;
    const parametros = request.params;
...
exports.eliminarReporteActividad = async(request, respuesta) => {
    // DELETE Request.
    const cabecera = request.headers;
    const cuerpo = request.body;
    const parametros = request.params;
